    ...
    match yao_setup {
        ...
        YaoSetup::E(_e) => {
            ...
            let recv: Vec<B2YMsg1> =
                receive_from_parties(setup, tag, msg.external_size(), &[0, 1], relay).await?;
    ...
    match yao_setup {
        ...
        YaoSetup::E(_e) => {
            ...
            let recv: Vec<Vec<B2YMsg1>> =
                receive_from_parties(setup, tag, msg.external_size() * batch_size, &[0, 1], relay)
                    .await?;
