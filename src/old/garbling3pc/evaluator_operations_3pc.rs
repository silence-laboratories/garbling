...
mod tests {
    ...
    use crate::{
        ...
        old::{
            ...
            garbling3pc::{
                comparison_circ_3pc::build_comparison_circuit_threeparty,
                threepartytraits::{
                    ThreePartyBinaryCircuit, ThreePartyBinaryCircuitBuilder,
                    ThreePartyBinaryEvaluator, ThreePartyBinaryGarbler,
                },
            },
        },
