...
mod tests {
    ...
    fn test_hash_function() {
        let input1 = [
            12, 162, 159, 171, 99, 41, 109, 231, 188, 136, 13, 175, 217, 232,
            245, 239, 31, 98, 162, 7, 107, 225, 88, 209, 168, 93, 151, 219,
            108, 165, 208, 176, 138, 251, 26, 222, 208, 10, 222, 35, 145,
            101, 76, 5, 1, 166, 11, 75, 192, 73, 215, 27, 61, 225, 131, 246,
            29, 123, 54, 21, 251, 185, 40, 148,
        ];
        let input2 = [
            91, 117, 139, 46, 166, 12, 148, 159, 202, 207, 188, 255, 197, 20,
            105, 245, 231, 123, 40, 30, 81, 29, 115, 244, 83, 231, 83, 26,
            70, 31, 69, 4, 16, 204, 166, 244, 5, 169, 230, 225, 124, 196,
        ...
        let required_output2 = [
            97, 216, 175, 252, 173, 133, 251, 12, 202, 131, 200, 32, 81, 60,
            0, 232,
        ];
